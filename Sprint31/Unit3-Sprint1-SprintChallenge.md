...
The biggest part of code review is having an extra set of eyes for me. I find that I frequently spend so long looking at my code that I forget that anyone else might ever need to. Code review helps me to remember to properly comment and document my code. I also frequently try to get 'clever' about my coding and end up doing more work than needed because theres a library function that does what I'm trying to do. Having an extra set of eyes for the code review can help to spot these kinds of issues. 

Containers work as a portable environment for programming in. By implementing containers you could get a more consistent working environment for your programing. A container has its own operating system framework to work in so that the minor differences between machines and their software won't cause as many conflicts. All of the requirements/dependencies of any packages will be installed inside of the containers and continue to work on all machines.
